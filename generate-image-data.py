...
class ImageProcessingApp(App):
    ...
    def process_images(self):
        ...
        subfolder_order = ["auraflow", "ultrapixel", "StableCascade", "kolors", "SD3M", "SD3_Ultra", "extrarealisticxl_2s", "helloworldxl_v7", "hghd_play_enh_hd", "hunyuandit", "ideogram", "dalle3", "midjourney"]
