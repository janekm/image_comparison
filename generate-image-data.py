...
class ImageProcessingApp(App):
    ...
    def process_images(self):
        ...
        subfolder_order = ["auraflow", "ultrapixel", "StableCascade", "kolors", "ideogram", "SD3M", "SD3_Ultra", "auraflow_llm", "extrarealisticxl_2s", "helloworldxl_v7", "hghd_play_enh_hd", "hunyuandit", "dalle3", "midjourney"]
